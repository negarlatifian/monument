...
const ContributionsPage: NextPage<ContributionsPageProps> = ({
  ...
  const images = contributions.map((c) => c.image);
  return (
    <>
      <Head>
      ...
      <div className='flex flex-col sm:ml-6 mt-15 sm:mr-15 mb-5'>
        <section className='flex flex-row text-[0.86rem] font-light leading-4 gap-20 mb-15 '>
          <div className='w-[87%] flex flex-col gap-5'>
            ...
            <p>
              These participants include mostly children, but also adults, from
              a variety of neighbourhoods in Gothenburg and Botkyrka. In each
              workshop, we offered the participants a set of random photographs
              of public spaces in the surrounding neighbourhood and beyond,
              taken from Google Street View. Each participant would choose a
              photograph to intervene upon.
            </p>
            <p>
          ...
          <div className='text-[rgb(186,186,186)] w-[87%] flex flex-col gap-5'>
            <p>
              ...
              staden som återstår att byggas], insamlat mellan 2021 och 2024.
            </p>
            <p>
              Bland deltagarna finns främst barn, men även vuxna, från en rad
              olika stadsdelar i Göteborg och Botkyrka. I varje workshop erbjöd
              vi deltagarna en uppsättning slumpmässiga fotografier av
              offentliga platser i och utanför det omgivande grannskapet, tagna
              från Google Street View. Varje deltagare skulle välja ett
              fotografi att bearbeta.
            </p>
            <p>
        ...
        <section className='flex flex-row text-[0.86rem] font-light leading-4 gap-20 mb-15 '>
          <div className='w-[87%] flex flex-col gap-5'>
            <p>
              ...
              Stället Konsthall, Hammarkullens skolan, Dômen konstskola,
              Göteborgs Botaniska Trädgård, Allas Ateljé, Konstepidemin,
              University of Gothenburg/HDK-Valand (lärarutbildning department),
          ...
          <div className='w-[87%] flex flex-col gap-5'>
            <p>
              ...
              Trädgård, Allas Ateljé, Konstepidemin, University of
